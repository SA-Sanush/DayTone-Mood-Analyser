(function () {
  ...
  const moodStates = {
    1: { label: 'Raw', primary: '#ef4444', secondary: '#f97316', sharpness: 1, calm: 0.2 },
    2: { label: 'Uneasy', primary: '#f97316', secondary: '#facc15', sharpness: 0.8, calm: 0.4 },
    3: { label: 'Balanced', primary: '#14b8a6', secondary: '#60a5fa', sharpness: 0.6, calm: 0.6 },
    4: { label: 'Lifted', primary: '#3b82f6', secondary: '#8b5cf6', sharpness: 0.4, calm: 0.8 },
    5: { label: 'Radiant', primary: '#8b5cf6', secondary: '#ec4899', sharpness: 0.2, calm: 1 }
  };
