...
from wtforms import BooleanField, DateField, FloatField, IntegerField, SelectField, StringField, SubmitField, TextAreaField
...
class AdminMoodLogForm(FlaskForm):
    ...
    mood_score = SelectField("Mood", coerce=int, choices=[(5, "😊 Happy"), (4, "😌 Calm"), (3, "😰 Anxious"), (2, "😢 Sad"), (1, "🤒 Sick")], validators=[DataRequired()])
    sleep_hours = FloatField("Sleep Hours", validators=[DataRequired(), NumberRange(min=0, max=24)])
    stress_level = SelectField("Stress Level", coerce=int, choices=[(1, "1 - Very Low"), (2, "2 - Low"), (3, "3 - Moderate"), (4, "4 - High"), (5, "5 - Extreme")], validators=[DataRequired()])
    social_interaction = SelectField("Social Interaction", coerce=int, choices=[(1, "👤 Alone"), (2, "👥 Group"), (3, "🗣️ Social")], validators=[DataRequired()])
